            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if(Auth::user() && Auth::user()->is_admin)
                        ...
                        <x-nav-link :href="route('representations.index')" :active="request()->routeIs('representations.index')">
                            {{ __('Representations') }}
                        </x-nav-link>
                    ...
                    @elseif(Auth::user() && !Auth::user()->is_admin)
                        ...
                        <x-nav-link :href="route('artists.index')" :active="request()->routeIs('artists.index')">
                            {{ __('Voir les artistes') }}
                        </x-nav-link>
                        <x-nav-link :href="route('representations.index')" :active="request()->routeIs('representations.index')">
                            {{ __('Voir les représentations') }}
                        </x-nav-link>
                        <x-nav-link :href="route('reservations.index')" :active="request()->routeIs('reservations.index')">
                            {{ __('Voir les réservations') }}
                        </x-nav-link>
                    @endif
                </div>
            </div>
